...
public class Message implements Serializable {
    ...
    /** NEW_TICKET */
    public static Message newTicket(String senderNodeId, int senderTcpPort, boolean senderAdmin, Ticket ticket) {
        Message m = new Message(Type.NEW_TICKET, senderNodeId, senderTcpPort, senderAdmin);
        m.ticket = ticket;
        return m;
    }

    /** UPDATE_STATUS */
    public static Message updateStatus(String senderNodeId, int senderTcpPort, boolean senderAdmin, String ticketId, String newStatus) {
        Message m = new Message(Type.UPDATE_STATUS, senderNodeId, senderTcpPort, senderAdmin);
        m.ticketId = ticketId;
    ...
    /** SYNC_REQUEST */
    public static Message syncRequest(String senderNodeId, int senderTcpPort, boolean senderAdmin) {
        return new Message(Type.SYNC_REQUEST, senderNodeId, senderTcpPort, senderAdmin);
    }

    /** SYNC_RESPONSE */
    public static Message syncResponse(String senderNodeId, int senderTcpPort, boolean senderAdmin, List<Ticket> tickets) {
        Message m = new Message(Type.SYNC_RESPONSE, senderNodeId, senderTcpPort, senderAdmin);
        m.ticketList = tickets;
        return m;
    }

    private Message(Type type, String senderNodeId, int senderTcpPort, boolean senderAdmin) {
        this.type = type;
